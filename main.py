...
INVONAME  = os.environ['Garage']
USERNAME  = os.environ['xxxxx@gmail.com']
PASSWORD  = os.environ['xxxxx']
SKILL_ID  = os.environ['amzn1.ask.skill.d9368fd3-20f3-4505-8e82-d99c2047ee9c']
